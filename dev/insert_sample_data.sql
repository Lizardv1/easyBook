...
(2, 1, '201', 'Deluxe', 'Spacious room with king bed and premium city views', 2),
(3, 1, '301', 'Suite', 'Luxurious suite with separate living area and skyline views', 4),
(4, 2, 'Ocean-1', 'Standard Ocean View', 'Ocean-facing room with balcony and beach access', 2),
(5, 2, 'Ocean-2', 'Deluxe Ocean View', 'Premium oceanfront room with king bed and private balcony', 2),
(6, 2, 'Beach-1', 'Beach Suite', 'Luxury beachfront suite with separate living area', 4),
(7, 3, '201', 'Standard', 'Clean and comfortable room perfect for business travelers', 2),
(8, 3, '302', 'Business', 'Spacious business room with work desk and city view', 2),
(9, 3, '501', 'Executive Suite', 'Premium suite with conference area and city panorama', 4);
...
(1, 2, '2025-10-10', '2025-10-14'),
(1, 3, '2025-10-20', '2025-10-25'),
-- Hotel 1 - Room 201
(2, 2, '2025-10-01', '2025-10-07'),
(2, 4, '2025-10-12', '2025-10-18'),
(2, 5, '2025-10-24', '2025-10-30'),
-- Hotel 1 - Room 301
(3, 3, '2025-10-05', '2025-10-10'),
(3, 1, '2025-10-15', '2025-10-22'),
(3, 4, '2025-10-28', '2025-11-02'),
-- Hotel 2 - Room Ocean-1
(4, 4, '2025-10-01', '2025-10-06'),
(4, 5, '2025-10-11', '2025-10-15'),
(4, 1, '2025-10-22', '2025-10-28'),
-- Hotel 2 - Room Ocean-2
(5, 5, '2025-10-03', '2025-10-08'),
(5, 3, '2025-10-14', '2025-10-19'),
(5, 2, '2025-10-25', '2025-10-31'),
-- Hotel 2 - Room Beach-1
(6, 1, '2025-10-07', '2025-10-12'),
(6, 4, '2025-10-16', '2025-10-21'),
(6, 5, '2025-10-27', '2025-11-03'),
-- Hotel 3 - Room 201
(7, 2, '2025-10-01', '2025-10-06'),
(7, 3, '2025-10-10', '2025-10-14'),
(7, 1, '2025-10-21', '2025-10-27'),
-- Hotel 3 - Room 302
(8, 3, '2025-10-04', '2025-10-09'),
(8, 5, '2025-10-13', '2025-10-17'),
(8, 2, '2025-10-23', '2025-10-29'),
-- Hotel 3 - Room 501
(9, 5, '2025-10-02', '2025-10-07'),
(9, 4, '2025-10-11', '2025-10-16'),
(9, 3, '2025-10-25', '2025-11-01');
